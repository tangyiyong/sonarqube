...
public class UserSessionFactoryImpl implements UserSessionFactory {
  ...
  public ServerUserSession create(UserDto user) {
    ...
    return new ServerUserSession(dbClient, organizationFeature, defaultOrganizationProvider, user);
  }

  @Override
  public ServerUserSession createAnonymous() {
    return new ServerUserSession(dbClient, organizationFeature, defaultOrganizationProvider, null);
  }
}
