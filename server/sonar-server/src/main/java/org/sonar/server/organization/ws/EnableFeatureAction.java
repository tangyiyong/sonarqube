...
public class EnableFeatureAction implements OrganizationsAction {
  private static final String ACTION = "enable_feature";
  ...
  public void define(WebService.NewController context) {
    context.createAction(ACTION)
      ...
      .setDescription("Enable support of organizations.<br />" +
        "'Administer System' permission is required.")
      .setInternal(true)
      .setPost(true)
      .setSince("6.3")
      .setHandler(this);
